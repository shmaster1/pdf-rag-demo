...
class EvaluationService:
    ...
    def evaluate_rag(self, question: str, answer: str, contexts: List[str], ground_truth: str):
        shaped_dataset =  self._build_dataset(question, answer, contexts, ground_truth)
        return self._run_evaluate(shaped_dataset)

    def _build_dataset(self, question, answer, contexts, ground_truth):
        shaped_dict = {
                            "question": [question],
                            "answer": [answer],
                            "contexts": [contexts],
